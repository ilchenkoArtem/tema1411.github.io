...
gulp.task('js', function () {
    return gulp.src([
        ...
        'app/libs/gsap/src/minified/TweenLite.min.js',
        'app/libs/gsap/src/minified/TimelineLite.min.js',
        'app/libs/gsap/src/uncompressed/plugins/CSSPlugin.js',
...
gulp.task('watch', ['styles', 'js', 'serve'], function () {
    ...
    gulp.watch(['add/libs/**/*.js', 'app/js/main.js'], ['js']);
